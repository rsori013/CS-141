// This is a dp problem that involves Longest increasing subsquence.
// first input will be theh number of digits and then we will input th
// digits and then we will find the logest increasing subsequence
...
// output : 3 -- will be the longest subsequence
// 4,7,9
